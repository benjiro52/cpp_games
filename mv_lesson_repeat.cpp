...
int main() {
    ...
    pos.x;
    pos.y;
    float speed = 0.1f; // сколько пикселей двигаться за один кадр, скорость
    ...
    // g++ mv_lesson_repeat.cpp -o mv_lesson_repeat.exe -IC:/msys64/ucrt64/include -LC:/msys64/ucrt64/lib -lsfml-graphics -lsfml-window -lsfml-system
